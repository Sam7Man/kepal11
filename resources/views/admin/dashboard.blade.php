            ...
            <div class="row">
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-primary card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="mb-5">Rp {{ number_format($pendapatan->penghasilan,2,',','.') }}</h4>
                  </div>
                </div>
              </div>
              <div class="col-md-3 stretch-card grid-margin">
              ...
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{ asset('adminassets') }}/assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Kategori <i class="mdi mdi-clipboard-list-outline mdi-24px float-right"></i><i class="mdi mdi mdi-table-large menu-icon"></i>
                    </h4>
                    <h2 class="mb-5">{{ $kategori->total_kategori }}</h2>
                  </div>
                </div>
              </div>
              <div class="col-md-3 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{ asset('adminassets') }}/assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Produk <i class="mdi mdi-shopping mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">{{ $produk->total_produk }}</h2>
                  </div>
                </div>
              </div>
            </div>
