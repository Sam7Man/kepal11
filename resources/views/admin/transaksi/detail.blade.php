                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row mb-3">
                      ...
                      <button onclick="history.back()" class="btn btn-gradient-info mdi mdi-backspace"> Kembali</button>
                      </div>
                    </div>
                    <hr>
                   <div class="row">
                   <div class="col-md-7">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;&nbsp;:</td>
                            <td  class="p-2">&nbsp;&nbsp;{{ openssl_decrypt($order->pesan, 'aes-128-cbc', base64_decode($order->encrypt_key), 0, base64_decode(explode(',', $order->signaiv)[0])) }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <div class="input-group">
                                ...
                                <button type="submit" class="btn btn-sm btn-primary" type="button"><i class="mdi mdi-content-save"></i> Simpan</button>
                                </div>
                            </div>
                            </div>
                            </form>
