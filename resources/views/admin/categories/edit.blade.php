                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row mb-3">
                      ...
                      <a href="{{ route('admin.categories') }}" class="btn btn-gradient-info mdi mdi-backspace"> Kembali</a>
                      </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{ route('admin.categories.update',['id' => $categorie->id]) }}" method="POST">
                                ...
                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary text-right"><i class="mdi mdi-content-save"></i> Simpan</button>
                                </div>
                            </form>
                        </div>
                    </div>
